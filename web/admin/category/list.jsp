...
<script type="text/javascript">
			...
			function isDelete(cid) {
				...
				if(b){
				    window.location.href = "${pageContext.request.contextPath}/adminCategoryDelete?cid=" + cid;
				}
            }
		</script>
</HEAD>
							...
							<c:forEach items="${categoryList}" var="cate" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
											href="${ pageContext.request.contextPath }/adminCategoryEdit?cid=${cate.cid}">
										<img
									...
									<td align="center" style="HEIGHT: 22px"><%--<a
											href="">--%>
										<img   onclick="isDelete('${cate.cid}')" src="${pageContext.request.contextPath}/images/i_del.gif"
